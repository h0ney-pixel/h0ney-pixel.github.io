...
## 📱 Für Gäste: WLAN-Verbindung

Wenn Besucher sich mit unserem WLAN verbinden möchten:

1. WLAN-Netzwerk auswählen: **„Home“**
2. Passwort eingeben (steht im Passwortmanager unter „WLAN“)
3. Fertig – Internet ist nutzbar.

> ⚠️ Gäste haben Zugriff auf das lokale Netzwerk. Sensible Geräte (z.B. NAS) sind aber geschützt.
